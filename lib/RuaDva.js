...
var RuaDva = (function (_super) {
    ...
    function RuaDva() {
        ...
        _this.booted = false;
        _this.actions = {};
        _this.dispatch = function () { return console.error('[Rua.js][dva]Dispatch method is not bound yet'); };
        _this.originalModelPath = '__rua_model';
        _this.originalUnmodelPath = '__rua_unmodel';
        _this.originalStartPath = '__rua_start';
        return _this;
    }
    ...
    RuaDva.prototype.interceptModel = function () {
        ...
        this.store.model = function (model) {
            ...
            return _this.store[_this.originalModelPath](model);
        };
    };
    ...
    RuaDva.prototype.interceptStart = function () {
        ...
        this.store.start = function () {
            ...
            var originalOutput = (_a = _this.store)[_this.originalStartPath].apply(_a, params);
    ...
    return RuaDva;
}(Abstractions_1.AbstractPackage));
